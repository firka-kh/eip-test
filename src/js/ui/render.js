(function initRenderModule() {
    ...
    function getGrantContractBodyHtml(fields) {
        ...
        return '' +
            ...
            '<p class="contract-place-date"><span class="date-row">Аз «' + lineValue('contractDateDay', ' ') + '» ' + lineValue('contractDateMonth', ' ') + ' соли 20' + lineValue('contractDateYear', ' ') + '</span><span class="city-row">ш. ' + lineValue('contractCity', ' ') + '</span></p>' +
